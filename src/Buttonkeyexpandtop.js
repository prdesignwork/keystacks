...
import './App.css';
import img_elMask from './images/Buttonkeyexpandtop_elMask.png';
import img_elButtonkey from './images/Buttonkeyexpandtop_elButtonkey.png';
import img_elIconexpand from './images/Buttonkeyexpandtop_elIconexpand.png';


export default class Buttonkeyexpandtop extends Component {
  ...
  render() {
    ...
    return (
      <div className="Buttonkeyexpandtop" style={baseStyle}>
        <div className="compContent">
          ...
          <div className='elLabel' style={style_label}>
            <div>{this.props.locStrings.buttonkeyexpandtop_label_18986}</div>
          </div>
